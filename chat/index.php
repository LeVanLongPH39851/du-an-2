...
<head>
    ...
    .list-group-item-left {
        text-align: left;
        /* Căn trái cho tin nhắn */
        background-color: #f0f0f0;
        /* Màu nền cho tin nhắn ở bên trái */
        border: 1px solid #ccc;
        /* Viền cho tin nhắn ở bên trái */
        border-radius: 5px;
        /* Bo tròn góc cho tin nhắn ở bên trái */
        margin-bottom: 5px;
        /* Khoảng cách giữa các tin nhắn */
        padding: 5px 10px;
        /* Khoảng cách nội dung trong tin nhắn */
    }

    .list-group-item-right {
        text-align: right;
        /* Căn phải cho tin nhắn */
        background-color: #d4edda;
        /* Màu nền cho tin nhắn ở bên phải */
        border: 1px solid #c3e6cb;
        /* Viền cho tin nhắn ở bên phải */
        border-radius: 5px;
        /* Bo tròn góc cho tin nhắn ở bên phải */
        margin-bottom: 5px;
        /* Khoảng cách giữa các tin nhắn */
        padding: 5px 10px;
        /* Khoảng cách nội dung trong tin nhắn */
