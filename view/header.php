        ...
        <div class="row align-items-center py-3 px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                <a href="" class="text-decoration-none">
                    <img style="margin-left: 10px;" width="150px" src="image/logotrangchu1.jpg" alt="">
                </a>
            </div>
            ...
            <div class="col-lg-3 col-6 text-right">
                ...
                <a <?php if(isset($_SESSION['user'])){?> href="index.php?act=cart" <?php }else{?>
                    onclick="return alert('Vui lòng đăng nhập')" <?php } ?> class="btn border">
