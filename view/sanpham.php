        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    $dssp=loadall_sanpham($page,$kyw,$iddm,$range,$sx);
             foreach($dssp as $sp){
                extract($sp);
                    ...
                    <div class="col-12 pb-1">
                        <nav aria-label="Page navigation">
                            <ul class="pagination justify-content-center mb-3">
                                <li class="page-item "><a class="page-link" href="index.php?act=sanpham&page=1">1</a>
                                </li>
                                <?php $number= pagenumbers()[0]['slsp'] / 12;
                                $page = ceil($number);
                                for ($i = 2; $i <= $page; $i++) :  ?>
                                <li class="page-item"><a class="page-link"
                                        href="index.php?act=sanpham&page=<?php echo $i ?>"><?php echo $i ?></a></li>
                                <?php endfor ?>
                                </li>
                            </ul>
                        </nav>
