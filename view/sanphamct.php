    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <form method="POST"
                    <?php if(isset($_SESSION['user'])){echo'action="index.php?act=addsptocart"';}else{echo '';}?>>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <?php if(isset($_SESSION['user'])){
                            echo ' <button type="submit" name="submit" class="btn btn-primary px-3"><i
                            class="fa fa-shopping-cart mr-1"></i>Thêm Vào Giỏ Hàng</button>';
                        }else{
                         ?>
                        <button type="submit" name="submit" onclick="return alert('Vui lòng đăng nhập để mua hàng')"
