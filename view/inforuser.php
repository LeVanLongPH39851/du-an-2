                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" disabled class="text-muted mb-0 form-control" name='hoten'
                                        value="<?php echo $tk[0]['hoten'] ?>">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input type="email" disabled value="<?php echo $tk[0]['email'] ?>" name='email'
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input name='phone' value="<?php echo $tk[0]['phone'] ?>" disabled name='phone'
                                        class="text-muted mb-0 form-control">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <input name='pass' type="password" value="<?php echo $tk[0]['pass'] ?>" disabled
                                        name='pass' class="text-muted mb-0 form-control">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-3">
